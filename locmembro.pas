...
procedure Tfrmlocmembro.Edit1Exit(Sender: TObject);
begin
  edit1.text:='';
end;

procedure Tfrmlocmembro.sairClick(Sender: TObject);
begin
  frmlocmembro.close;
end;

procedure Tfrmlocmembro.op1Click(Sender: TObject);
begin
 edit2.SetFocus;
end;

procedure Tfrmlocmembro.Edit1KeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure Tfrmlocmembro.BitBtn1Click(Sender: TObject);
var
  x,a:string;
begin
  with data10.myprocura do begin
    ...
    sql.add(x);
    open;
    frmlocmembro.Caption:='Membros = '+inttostr(recordcount);
  end;
  edit2.Text:='';
  dbgrid1.SetFocus;
end;

procedure Tfrmlocmembro.Edit3Exit(Sender: TObject);
begin
...
procedure Tfrmlocmembro.FormShow(Sender: TObject);
var
  i:integer;
begin
...
procedure Tfrmlocmembro.Edit2KeyPress(Sender: TObject; var Key: Char);
begin
  If Key = #13 Then Begin SelectNext(Sender as tWinControl, True, True ); Key := #0; end;
end;

procedure Tfrmlocmembro.DBGrid1TitleClick(Column: TColumn);
Var
  i, iTemp : Integer;
begin
  i := 0;
...
procedure Tfrmlocmembro.DBGrid1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure Tfrmlocmembro.FormClose(Sender: TObject;
