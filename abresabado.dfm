object frmabresabado: Tfrmabresabado
  Left = 410
  Top = 240
  BorderStyle = bsDialog
  Caption = 'Abre Movimento ES S'#225'bado'
  ClientHeight = 432
  ClientWidth = 871
  Color = clBtnFace
  ...
  object lsab: TJvCheckListBox
    Left = 8
    Top = 80
    Width = 337
    Height = 265
    Cursor = crHandPoint
    OnClickCheck = lsabClickCheck
    Font.Charset = ANSI_CHARSET
    Font.Color = clWindowText
    Font.Height = -16
    Font.Name = 'Arial'
  ...
  object Panel1: TPanel
    ...
    Width = 497
    Height = 41
    Caption = 'S'#225'bado Aberto = 00/00/0000'
    Color = clGreen
    Font.Charset = ANSI_CHARSET
    Font.Color = clWhite
    Font.Height = -21
