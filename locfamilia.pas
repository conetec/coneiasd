...
procedure Tfrmlocfamilia.Edit1Exit(Sender: TObject);
begin
  edit1.text:='';
end;

procedure Tfrmlocfamilia.sairClick(Sender: TObject);
begin
  frmlocfamilia.close;
end;

procedure Tfrmlocfamilia.op1Click(Sender: TObject);
begin
 edit2.SetFocus;
end;

procedure Tfrmlocfamilia.Edit1KeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure Tfrmlocfamilia.BitBtn1Click(Sender: TObject);
var
  x,a:string;
begin
  with data10.myprocura do begin
    ...
    sql.add(x);
    open;
    frmlocfamilia.Caption:='Famílias = '+inttostr(recordcount);
  end;
  edit2.Text:='';
  dbgrid1.SetFocus;
end;

procedure Tfrmlocfamilia.Edit3Exit(Sender: TObject);
begin
...
procedure Tfrmlocfamilia.FormShow(Sender: TObject);
var
  i:integer;
begin
...
procedure Tfrmlocfamilia.Edit2KeyPress(Sender: TObject; var Key: Char);
begin
  If Key = #13 Then Begin SelectNext(Sender as tWinControl, True, True ); Key := #0; end;
end;

procedure Tfrmlocfamilia.DBGrid1TitleClick(Column: TColumn);
Var
  i, iTemp : Integer;
begin
  i := 0;
...
procedure Tfrmlocfamilia.DBGrid1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure Tfrmlocfamilia.FormClose(Sender: TObject;
