...
procedure Tfrmlocamigo.Edit1Exit(Sender: TObject);
begin
  edit1.text:='';
end;

procedure Tfrmlocamigo.sairClick(Sender: TObject);
begin
  frmlocamigo.close;
end;

procedure Tfrmlocamigo.op1Click(Sender: TObject);
begin
 edit2.SetFocus;
end;

procedure Tfrmlocamigo.Edit1KeyUp(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure Tfrmlocamigo.BitBtn1Click(Sender: TObject);
var
  x,a:string;
begin
  with data10.myprocura do begin
    ...
    sql.add(x);
    open;
    frmlocamigo.Caption:='Amigos = '+inttostr(recordcount);
  end;
  edit2.Text:='';
  dbgrid1.SetFocus;
end;

procedure Tfrmlocamigo.Edit3Exit(Sender: TObject);
begin
...
procedure Tfrmlocamigo.FormShow(Sender: TObject);
var
  i:integer;
begin
...
procedure Tfrmlocamigo.Edit2KeyPress(Sender: TObject; var Key: Char);
begin
  If Key = #13 Then Begin SelectNext(Sender as tWinControl, True, True ); Key := #0; end;
end;

procedure Tfrmlocamigo.DBGrid1TitleClick(Column: TColumn);
Var
  i, iTemp : Integer;
begin
  i := 0;
...
procedure Tfrmlocamigo.DBGrid1KeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure Tfrmlocamigo.FormClose(Sender: TObject;
